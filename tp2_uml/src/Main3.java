...
public class Main3 {
    public static void main(String[] args) {
        ...
        Contratado empleado5 = new Contratado(60000, LocalDate.of(1980, 8, 10), "Soltero", "Calle Falsa 456", "Ana Garcia", 1, "Transferencia");
        System.out.println("empleados.Empleado 5 edad: " + empleado5.calcularEdad());
        Contratado empleado6 = new Contratado(45000, LocalDate.of(1992, 11, 5), "Casado", "Avenida Siempre Viva 123", "Pedro Martinez", 10, "Cheque");
        System.out.println("empleados.Empleado 6 edad: " + empleado6.calcularEdad());
        System.out.println("--------------------------------------------------");
