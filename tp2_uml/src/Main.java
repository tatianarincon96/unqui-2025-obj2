...
public class Main {
    public static void main(String[] args) {
        ...
        PlantaPermanente empleado1 = new PlantaPermanente(50000, LocalDate.of(1985, 5, 20), "empleados.estadocivil.Casado", "Calle Falsa 123", "Juan Perez", 2, 10);
        System.out.println("empleados.Empleado 1 edad: " + empleado1.calcularEdad());
        PlantaTemporaria empleado2 = new PlantaTemporaria(40000, LocalDate.of(1990, 3, 15), "empleados.estadocivil.Soltero", "Avenida Siempre Viva 742", "Maria Lopez", LocalDate.of(2024, 12, 31), 5);
        System.out.println("empleados.Empleado 2 edad: " + empleado2.calcularEdad());
        System.out.println("--------------------------------------------------");
